        ...
        <Grid container spacing={2} className="card">
            <Grid item xs={6} sm={6} md={4} lg={4}>
                <Grid container alignItems="center" className="icon-container-move">
                    ...
                    <Grid item>
                        <Typography variant="body2" className="label"> { home || '2 Stories'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={6} sm={6} md={4} lg={4}>
                <Grid container alignItems="center"  className="icon-container-move">
                    ...
                    <Grid item>
                        <Typography variant="body2" className="label" >{ bed || '4 Beds'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={6} sm={6} md={4} lg={4}>
                <Grid container alignItems="center"  className="icon-container-move">
                    ...
                    <Grid item>
                        <Typography variant="body2" className="label">{ bath || '4 Baths'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={6} sm={6} md={4} lg={4}>
                <Grid container alignItems="center"  className="icon-container-move">
                    ...
                    <Grid item>
                        <Typography variant="body2" className="label">{ garages || '2 Garages'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={6} sm={6} md={4} lg={4}>
                <Grid container alignItems="center"  className="icon-container-move">
                    ...
                    <Grid item>
                        <Typography variant="body2" className="label">{ sqft || '3335 Sq. Ft'}</Typography>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
